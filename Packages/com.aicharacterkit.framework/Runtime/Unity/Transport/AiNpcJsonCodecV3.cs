...
{
    /// <summary>
    /// Serializes validated action-aware V3 conversation and reset envelopes.
    /// </summary>
    public static class AiNpcJsonCodecV3
    {
        ...
        /// <summary>
        /// Serializes one valid V3 action-aware conversation request.
        /// </summary>
        ...
        /// <summary>
        /// Deserializes and validates one V3 action-aware conversation request.
        /// </summary>
        ...
        /// <summary>
        /// Serializes one valid V3 conversation response with only its active branch.
        /// </summary>
            ...
            out string error)
        {
            ...
            try
            {
                json = response.status == AiNpcContractV3.SuccessStatus
        ...
        /// <summary>
        /// Deserializes and validates one V3 action-aware conversation response.
        /// </summary>
        ...
        /// <summary>
        /// Serializes one valid V3 session reset request.
        /// </summary>
        ...
        /// <summary>
        /// Deserializes and validates one V3 session reset request.
        /// </summary>
        ...
        /// <summary>
        /// Serializes one V3 reset response with only its active branch.
        /// </summary>
        ...
        /// <summary>
        /// Deserializes and validates one V3 session reset response.
        /// </summary>
            ...
            where T : class
        {
            if (value is AiNpcResponseEnvelopeDto response)
            {
                ...
                else if (response.status == AiNpcContractV3.ErrorStatus
            ...
            {
                if (resetResponse.status == AiNpcContractV3.SuccessStatus
                    && GetTopLevelPropertyValue(json, "error") != TopLevelPropertyValue.Other
                    && IsEmptyError(resetResponse.error))
                {
                    resetResponse.error = null;
                }
                else if (resetResponse.status == AiNpcContractV3.ErrorStatus
                    && GetTopLevelPropertyValue(json, "result") != TopLevelPropertyValue.Other
